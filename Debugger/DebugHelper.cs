...
namespace Debugger
{
    ...
    internal static class DebugHelper
    {
        ...
        internal static string GetLogFile(string logFile)
        {
            ...
            if (new FileInfo(logFilePath).Length <= DebugRegister.MaxFileSize) return logFilePath;
        ...
        private static string RotateLogFiles(string logFilePath)
        {
            ...
            {
                var olderLogFile = Path.Combine(logFileDirectory, $"{logFileNameWithoutExtension}_{i}{logFileExtension}");
                var newerLogFile = Path.Combine(logFileDirectory, $"{logFileNameWithoutExtension}_{i + 1}{logFileExtension}");
            ...
            var firstBackupLogFile = Path.Combine(logFileDirectory, $"{logFileNameWithoutExtension}_1{logFileExtension}");
