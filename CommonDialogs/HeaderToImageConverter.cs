...
namespace CommonDialogs
{
    ...
    public sealed class HeaderToImageConverter : IValueConverter
    {
        ...
        public object? Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return imagePath != null ? GetBitmapImageFileStream(imagePath) : null;
        }
        ...
        /// <summary>
        /// Gets the bitmap image file stream.
        /// </summary>
        /// <param name="path">The path.</param>
        /// <param name="width">The width.</param>
        /// <param name="height">The height.</param>
        /// <returns></returns>
        private static BitmapImage GetBitmapImageFileStream(string path, int width = 0, int height = 0)
        {
